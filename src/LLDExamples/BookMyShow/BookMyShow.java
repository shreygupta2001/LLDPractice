package LLDExamples.BookMyShow;

import LLDExamples.BookMyShow.Enums.City;
import LLDExamples.BookMyShow.Enums.SeatCategory;
...
public class BookMyShow {
    ...
    private void createTheatre() {
        ...
        Show inoxMorningShow = createShows(1, inoxTheatre.getScreen().getFirst(), avengerMovie, 8);
        Show inoxEveningShow = createShows(2, inoxTheatre.getScreen().getFirst(), baahubali, 16);
